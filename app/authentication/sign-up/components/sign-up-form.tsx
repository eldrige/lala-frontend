...
export function SignUpStep() {
  return (
    ...
    >
      <button className="bg-white justify-center w-full hover:bg-gray-100 font-semibold border border-gray-100 text-gray-800 active:scale-95 gap-2 transition-all flex items-center px-3 rounded-lg py-2">
